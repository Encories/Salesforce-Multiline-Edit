...
import getRecordsByName from '@salesforce/apex/MultilineCtrl.getRecordsByName';

export default class MultilineLookup extends LightningElement {
    ...
    setSelectedValue(event) {
        ...
        const selectedEvent = new CustomEvent('setAccount', {
            detail: {
