...
export default class Multiline extends NavigationMixin (LightningElement) {
    ...
    editAccount(event) {
        const inputId = event.target.dataset.inputid;
        console.log('const inputId' + inputId);
        const inputIdName = this.template.querySelector('lightning-pill-container[data-editid="' + inputId + '"]');
        inputIdName.classList.toggle("slds-hidden");
        inputIdName.focus();
        this.currentValue = event.target.dataset.opportunitydate;
        console.log('currentValue' + this.currentValue);
    ...
    setAccount(event) {
        ...
        console.log('selectedAccount+' + JSON.stringify(event.target.dataset.opportunityid));
        this.opportunities = this.opportunities.map(function (opportunity) {
            if (opportunity.Id === event.target.dataset.opportunityid) {
    ...
    onFocusOut(event) {
        ...
        const opportunityAcctId = event.target.dataset.opportunityacctid;
        console.log('editId=>' + editId);
        console.log('editId=>' + opportunityAcctId);
