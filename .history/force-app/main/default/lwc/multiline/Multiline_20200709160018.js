...
export default class Multiline extends NavigationMixin (LightningElement) {
    ...
    setAccount(event) {
        ...
        this.template.querySelector('span[data-editid="' + editid + '"]').innerHTML = event.detail.Name;
        this.template.querySelector('span[data-editid="' + editid + '"]').style.backgroundColor = "#FAFFBD";
